...
public class Utils {
	...
	public static String generateEmailWithTimeStamp() {
		...
		return "rani1804"+timestamp+"@gmail.com";
}
	public static Object[][] getTestDataFromExcel(String sheetName) {
		File excelFile=new File(System.getProperty("user.dir")+"\\src\\main\\java\\com\\tutorialninja\\qa\\testdata\\tutorials ninja testdata.xlsx");
